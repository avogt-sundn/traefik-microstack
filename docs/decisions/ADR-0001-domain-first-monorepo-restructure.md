...
The original Angular workspace at `frontend/` contained all apps (`shell`, `partner`, `ekf`, `loans`) as projects under `frontend/projects/`. This monolithic workspace layout meant:
...
- `partner-search/frontend/` — partner-search Angular remote
- `partner-edit/frontend/` — partner-edit Angular remote
